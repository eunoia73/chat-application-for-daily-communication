package com.one.social_project.domain.user.mail.controller;

import com.one.social_project.domain.user.mail.dto.EmailDto;
import com.one.social_project.domain.user.mail.service.EmailService;
